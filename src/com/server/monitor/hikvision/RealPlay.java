...
public class RealPlay {
	 ...
	 */
	public RealPlay(NativeLong UserID, int channel, Panel playPanel) {
	...
	public static void FullScreen(MouseEvent e) {
		...
		// 播放视频信息
//		Map<String, Object> Realplay = Hikvision.m_DeviceHikvisionRealPlay.get(e.getComponent().getName());
		// 用户参数
