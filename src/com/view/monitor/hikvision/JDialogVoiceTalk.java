...
public class JDialogVoiceTalk extends javax.swing.JDialog {
	...
	/*************************************************
	 * 函数: JDialogVoiceTalk 函数描述: 构造函数 Creates new form JDialogVoiceTalk
	 *************************************************/
	public JDialogVoiceTalk(java.awt.Frame parent, boolean modal, NativeLong lUserID,
	...
	private void initComponents() {
		...
		jPanelLayout.setHorizontalGroup(jPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanelLayout.createSequentialGroup().addGroup(jPanelLayout
						...
						.addGroup(jPanelLayout.createSequentialGroup().addGap(18, 18, 18).addGroup(jPanelLayout
								.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(jPanelLayout.createSequentialGroup().addComponent(jButtonStart)
										.addGap(36, 36, 36).addComponent(jButtonStop))
								.addGroup(jPanelLayout.createSequentialGroup().addComponent(jLabel1).addGap(18, 18, 18)
										.addComponent(jComboBoxVoiceChannel, javax.swing.GroupLayout.PREFERRED_SIZE, 82,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addGap(28, 28, 28).addComponent(jLabelStatus,
												javax.swing.GroupLayout.PREFERRED_SIZE, 45,
												javax.swing.GroupLayout.PREFERRED_SIZE))))
						.addGroup(jPanelLayout.createSequentialGroup().addGap(86, 86, 86).addComponent(jLabel2)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
								.addComponent(jComboBoxDataType, javax.swing.GroupLayout.PREFERRED_SIZE,
		...
		jPanelLayout.setVerticalGroup(jPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanelLayout.createSequentialGroup().addContainerGap()
						.addGroup(jPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								...
								.addComponent(jComboBoxVoiceChannel, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						...
						.addGap(18, 18, 18)
						.addGroup(jPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jLabel2).addComponent(jComboBoxDataType,
	...
	{// GEN-HEADEREND:event_jButtonStartActionPerformed
		...
		Monitor.g_lVoiceHandle = hCNetSDK.NET_DVR_StartVoiceCom_V30(m_lUserID, m_iSel + 1,
				jComboBoxDataType.getSelectedIndex() == 1, fVoiceDataCallBack, null);
		if (Monitor.g_lVoiceHandle.intValue() == -1) {
	...
	{// GEN-HEADEREND:event_jButtonStopActionPerformed
		if (Monitor.g_lVoiceHandle.intValue() >= 0) {
			if (hCNetSDK.NET_DVR_StopVoiceCom(Monitor.g_lVoiceHandle)) {
				Monitor.g_lVoiceHandle.setValue(-1);
			} else {
