...
/*****************************************************************************
 * 类 ：JDialogChannelConfig 类描述 ：通道参数配置
 ****************************************************************************/
public class JDialogChannelConfig extends javax.swing.JDialog {
	...
	/*************************************************
	 * 函数: JDialogChannelConfig 函数描述: 构造函数
	 *************************************************/
	...
	private void initComponents() {
		...
		jComboBoxCompressType
				.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "录像(主码流)", "网传(子码流)", "事件触发" }));
		...
		jComboBoxImageQulity
				.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "最好", "次好", "较好", "一般", "较差", "差" }));

		jComboBoxFrameRate.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "全部", "1/16", "1/8", "1/4",
		...
		jComboBoxMaxBitRate.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "32K", "48K", "64K", "80K",
				...
				"1024K", "1280K", "1536K", "1792K", "2048K", "自定义" }));
												...
												.addGroup(jPanelCompressParaLayout.createSequentialGroup()
														...
														.addGroup(jPanelCompressParaLayout
																...
																.addComponent(jComboBoxBpInterval, 0, 67,
																		Short.MAX_VALUE)))
												.addComponent(jButtonCompressOK, javax.swing.GroupLayout.DEFAULT_SIZE,
														javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))));
		...
		jComboBoxPreRecordTime.setModel(new javax.swing.DefaultComboBoxModel(
				new String[] { "不预录", "5秒", "10秒", "15秒", "20秒", "25秒", "30秒", "不受限制" }));

		jComboBoxRecordDelay.setModel(
				new javax.swing.DefaultComboBoxModel(new String[] { "5秒", "10秒", "30秒", "1分", "2分", "5分", "10分" }));
		...
		jComboBoxOSDFormat
				.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "透明 不闪烁", "不透明 闪烁", "不透明 不闪烁" }));

		jComboBoxDateFormat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "XXXX-XX-XX (年月日)",
				"XX-XX-XXXX (月日年)", "XXXX年XX月XX日", "XX月XX日XXXX年", "XX-XX-XXXX 日月年", "XX日XX月XXXX年" }));
						...
						.addGroup(jPanel2Layout.createSequentialGroup().addGroup(jPanel2Layout
								...
								.addGroup(
										...
										jPanel2Layout
												...
												.addComponent(jSeparator1, javax.swing.GroupLayout.DEFAULT_SIZE, 568,
														Short.MAX_VALUE)
												.addGap(97, 97, 97))
								.addGroup(jPanel2Layout
										...
										.addGroup(jPanel2Layout
												.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
												.addComponent(jButtonSetMotion).addComponent(jButtonSetHideAlarm)))
								.addGroup(jPanel2Layout.createSequentialGroup().addGroup(jPanel2Layout
										.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
										.addComponent(jLabel15)
										.addGroup(jPanel2Layout.createSequentialGroup().addComponent(jCheckBoxOSD)
	...
	/*************************************************
	 * 函数: " 保存压缩参数" 按钮响应函数 函数描述: 保存压缩参数到结构体
	 *************************************************/
	...
	private void jButtonSetHideAreaActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButtonSetHideAreaActionPerformed
		...
		Monitor.centerWindow(dlg);
		dlg.setVisible(true);
	}// GEN-LAST:event_jButtonSetHideAreaActionPerformed

	/*************************************************
	 * 函数: 信号丢失 "设置 " 按钮响应函数 函数描述: 设置信号丢失报警参数
	 *************************************************/
	...
	/*************************************************
	 * 函数: 移动侦测 "设置 " 按钮响应函数 函数描述: 设置移动侦测报警参数
	 *************************************************/
	...
	/*************************************************
	 * 函数: "叠加字符 " 按钮响应函数 函数描述: 打开叠加字符设置对话框,设置叠加字符参数
	 *************************************************/
	private void jButtonStringActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButtonStringActionPerformed
		...
		JDialogShowString dialogShowString = new JDialogShowString(this, true, m_strShowString, lUserID,
				iChannelNumber);// 有模式对话框
		dialogShowString.setSize(330, 300);
		Monitor.centerWindow(dialogShowString);
	...
	/*************************************************
	 * 函数: "设置当前通道参数 " 按钮响应函数 函数描述: 设置当前通道参数
	 *************************************************/
	...
	/*************************************************
	 * 函数: "通道号 "组合框 选项改变事件响应函数 函数描述: 获取并显示通道号中通道数对应的通道参数
	 *************************************************/
	...
	/*************************************************
	 * 函数: "压缩参数类型 "组合框 选项改变事件响应函数 函数描述: 获取并显示压缩参数类型对应的参数
	 *************************************************/
	...
	/*************************************************
	 * 函数: 定时录像 "设置" 按钮单击响应函数 函数描述: 弹出对话框显示和设置录像参数
	 *************************************************/
	private void jButtonSetRecordActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButtonSetRecordActionPerformed
		...
		Monitor.centerWindow(dialogRecordSchedule);
	...
	/*************************************************
	 * 函数: "遮盖" checkbox 选项改变事件响应函数 函数描述: 设置按钮enable属性
	 *************************************************/
	...
	/*************************************************
	 * 函数: "移动侦测" checkbox 选项改变事件响应函数 函数描述: 设置按钮enable属性
	 *************************************************/
	...
	/*************************************************
	 * 函数: "视频信号丢失报警" checkbox 选项改变事件响应函数 函数描述: 设置按钮enable属性
	 *************************************************/
	...
	/*************************************************
	 * 函数: "遮挡报警" checkbox 选项改变事件响应函数 函数描述: 设置按钮enable属性
	 *************************************************/
	...
	/*************************************************
	 * 函数: showChannelConfig 函数描述: 获取通道参数并显示
	 *************************************************/
