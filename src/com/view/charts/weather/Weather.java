...
public class Weather extends Echarts {
	...
	public Weather line(String categoryAxisLabel, String valueAxisLabel) {
...
//		plot.setRangeGridlinesVisible(false);
		...
		renderer.setDefaultItemLabelGenerator(new LineGenerator(null));
		// 对其他部分进行渲染
		// X坐标轴渲染
	...
	public Weather size(int width, int height) {
		this.width = width;
		this.height = height;
		return this;
	}
 ...
 *
 */
class LineGenerator extends AbstractCategoryItemLabelGenerator implements CategoryItemLabelGenerator {
	private static final long serialVersionUID = 1L;

	public LineGenerator(int paramInt) {
		this(Integer.valueOf(paramInt));
	}

	public LineGenerator(Integer paramInteger) {
	...
	public String generateLabel(CategoryDataset dataset, int series, int category) {
		...
		if (value != null) {
			result = (series == 0 ? "低温" : "高温") + ":" + value.toString() + " ℃";
		}
		return result;
	}
