...
public class Parking extends JPanel {
	...
	public Parking(int width, int height) {
		this(width, height, "停车场", "parking lot");
	}
	 ...
	 * @param subTit
	 */
	public Parking(int width, int height, String tit, String subTit) {
		JScrollPane scrollPane = new JScrollPane(table());
		scrollPane.setOpaque(false);
		scrollPane.getViewport().setOpaque(false);
		scrollPane.setBorder(BorderFactory.createEmptyBorder(0, 10, 10, 10));
		Cpanel panel = new Cpanel(tit, subTit, scrollPane);
		setOpaque(false);
