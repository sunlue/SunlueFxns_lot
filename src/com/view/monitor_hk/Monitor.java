...
/*****************************************************************************
 * 主类 ：Monitor 用途 ：用户注册，预览，参数配置菜单 容器：Frame
 ****************************************************************************/
public class Monitor extends JFrame {
	...
	private void initComponents() {
		...
		jComboBoxCallback = new javax.swing.JComboBox<String>();
		...
		jSplitPaneHorizontal.setDividerLocation(180);
		...
		jPanelUserInfoLayout.setVerticalGroup(jPanelUserInfoLayout
				...
				.addGroup(jPanelUserInfoLayout.createSequentialGroup().addGap(18, 18, 18)
						.addGroup(jPanelUserInfoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								...
								.addComponent(jTextFieldIPAddress, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
						.addGap(9, 9, 9)
						.addGroup(jPanelUserInfoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
	...
	private void jButtonLoginActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButtonLoginActionPerformed
		...
		if (userID == -1) {
			...
			JOptionPane.showMessageDialog(Monitor.this, "注册失败");
		} else {
			CreateDeviceTree();
		}
